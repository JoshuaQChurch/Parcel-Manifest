...
class MainApplication:
    ...
    def __main_menu(self):
        ...
        self.__set_geometry(width = 375, height = 375)
        tk.Label(self.root, text = "Select Macro", font = ("Arial", 16, "bold")).place(x = 100, y = 10)
        ...
        reprint_button.place(x = 25, y = 60)
        ...
        carton_manifest_button.place(x = 200, y = 60)
        ...
        salesman_code_button.place(x = 25, y = 230)
    ...
    def __config_reprint(self):
        ...
        self.macro = "reprint"
        self.__set_geometry(width = 550, height = 420, resizable = True)
    ...
    def __set_position_instructions(self):
        ...
        self.__set_geometry(width = 850, height = 400, resizable = True)
    ...
    def __set_position(self):
        ...
        button.place(x = 145, y = 75)

        # Move Down
        button = tk.Button(self.root, text = "Move Down", command = lambda: self.__move_cursor(0, 200))
        button.config(height = 2, width = 9, font = ("Arial", 12, "bold"))
    ...
    def __config_carton_manifest(self):
        ...
        self.__set_geometry(width = 500, height = 390, resizable = True)
    ...
    def __set_carton_count(self):
        ...
        self.__set_geometry(width = 450, height = 220)
    ...
    def __any_issues(self):
        self.__set_geometry(width = 350, height = 200)
    ...
    def __remove_problem_cells(self):
        ...
        button.config(height = 2, width = 10, font = ("Arial", 12))
        button.place(x = 255, y = 325)

        button = tk.Button(self.root, text = "Return to\nMain Menu", command = lambda: self.__confirm_main_menu())
        button.config(height = 3, width = 10, font = ("Arial", 12, "bold"))
        button.place(x = 25, y = 415)
    ...
    def __config_salesman_code(self):
        ...
        self.__set_geometry(width = 480, height = 450, resizable = True)
